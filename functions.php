...
/*-----------------------------------------------------------------------------------*/
	function xray_scripts()  { 
		...
		wp_enqueue_style('custom_font', '//use.typekit.net/uxr1fgu.css');
...
// Register Custom Post Type
function custom_post_type_local__vacancies() {

	$labels = array(
		'name'                  => _x( 'Job Vacancies', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Job Vacancy', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Job Vacancies', 'text_domain' ),
		'name_admin_bar'        => __( 'Job Vacancies', 'text_domain' ),
...
add_action( 'init', 'custom_post_type_local__vacancies', 0 );

function custom_post_type_staff_ava() {

	$labels = array(
		'name'                  => _x( 'Avaliable Staff', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Avaliable Staff', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Avaliable Staff', 'text_domain' ),
		'name_admin_bar'        => __( 'Avaliable Staff', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Avaliable Staff', 'text_domain' ),
		'description'           => __( 'Avaliable Staff', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title','thumbnail' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'staff_ava', $args );

}
add_action( 'init', 'custom_post_type_staff_ava', 0 );
